...
/**
 *  This class is the main class of the "Cruiser Command" application. 
 ...
 * 
 *  To play this game, run the main method in the CruiserInit class.
 * 
...
public class Game {
     ...
     */
    public Game() {
    	this.player = new Player("Erik","En person",false);
        createRooms();
    ...
    private void createRooms() {
        ...
        Object house = new Object("House", "The house is a beautiful colonial house which is painted white. It is clear that the owners must have been extremely wealthy",false,false);
        
        w_house = new Room("You are standing in an open field west of a white house, with a boarded front door");
        w_house.getInventory().addObject(new Object("door","The door is closed.",false,false));
        ...
        n_house.getInventory().addObject(new Object("window","",false,false));
        ...
        e_house.getInventory().addObject(new Object("window","The window is slightly ajar, but not enough to allow entry. Inside it, you can see what appears to be a kitchen",false,false,"kitchenWindow"));
        ...
        s_house.getInventory().addObject(new Object("window","",false,false));
        ...
        sack.addItem(new Item("clove of garlic",""));
        kitchen.getInventory().addObject(sack);
        kitchen.getInventory().addObject(new Object("chimney","The chimney leads downward, and looks climbable.",false,false));
        kitchen.getInventory().addObject(new Object("window", "The kitchen window is open but I can't tell what's beyond it.",false,false));
        ...
        livingRoom.getInventory().addObject(new Object("door","The engravings translate to \"This space intentionally left blank\".",false,false,"engravedDoor"));
        livingRoom.getInventory().addObject(new Object("trophy-case","The trophy-case is empty.",false,false));
        livingRoom.getInventory().addObject(new Object("carpet","This heavy carpet covers most of the room. It seems to be slightly higher in the middle.",false,false, "orientalRug"));
        ...
        cellar = new Room("You are in a dark and damp cellar with a narrow passageway leading north.\nOn the west is the bottom of a steep metal\nramp which is unclimbable.",true,"\nThe trap door crashes shut, and you hear someone barring it.", "Cellar");
        cellar.getInventory().addObject(new Object("trapdoor", "The trap door is closed.",false,false,"trapdoor"));
        ...
        trollRoom = new Room("This is a small room with a passage to the east. Bloodstains and deep scratches \n(perhaps made by an axe) mar the walls.\nA nasty-looking troll, brandishing a bloddy axe, blocks all passages out\nof the room.",true,"Your sword has begun to glow very brightly","Troll room");
        trollRoom.getInventory().addObject(new Player("Troll", "A nasty-looking troll, brandishing a bloddy axe, blocks the passage to the east.",false));
        ...
        treasureRoom.getInventory().addObject(new Item("Luciabun","Amazing pastry"));
        
        new Door(treasureRoom, trollRoom,"west","east","The troll fends you off with a menacing gesture.");
        
        currentRoom = w_house;  // start game outside
    }
    ...
    public void play(){            
        ...
        while (!finished) {
        	...
        	for(Object o : player.getCurrentRoom().getContents()){
            	if(o.getName().equals("Troll")){
            		attacked = true;
            	}
            }
            finished = parser.getCommand(currentRoom,player);
            for(Object o : player.getCurrentRoom().getContents()){
